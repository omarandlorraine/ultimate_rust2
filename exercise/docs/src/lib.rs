...
///
pub struct Pumpkin {
    /// percentage of how round your pumpkin is
    pub roundness: f32,
    /// Orangeness. Between 8 and 27.
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// Smash the pumpkin. It will no longer be okay to use for pie.
    pub fn smash(self) {}
}
...
/// This constant defines the orangeness of a pumpkin. It is a valid value for the `orangeness`
/// field of the [`Pumpkin`] struct.
